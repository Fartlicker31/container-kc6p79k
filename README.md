...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-kc6p79k.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-kc6p79k.containers.anotherwebservice.com/
...
```
git clone git@github.com:Fartlicker31/container-kc6p79k.git
cd container-kc6p79k
```
...
```
docker attach container-kc6p79k
```
